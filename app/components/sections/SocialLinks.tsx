...
export default function SocialLinks() {
  ...
  const socials = [
    { name: "LinkedIn", url: socialLinks.linkedin, icon: socialIcons.linkedin },
    {
      name: "Instagram",
      url: socialLinks.instagram,
      icon: socialIcons.instagram,
    },
    { name: "TikTok", url: socialLinks.tiktok, icon: socialIcons.tiktok },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        <motion.h2
          ...
          variants={fadeInUp}
          className="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-12 md:mb-16 text-center"
        >
          Connect With Us
        </motion.h2>
